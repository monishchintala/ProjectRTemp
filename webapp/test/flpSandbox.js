		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#samviewprojectrtemp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"samviewprojectrtemp-display": {
								"semanticObject": "samviewprojectrtemp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=samview.projectrtemp",
									"url": sap.ui.require.toUrl("samview/projectrtemp")
								}
							}
						}
					}
